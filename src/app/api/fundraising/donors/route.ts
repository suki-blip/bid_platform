  ...
  const statements: { sql: string; args: (string | number | null)[] }[] = [
    {
      sql: `INSERT INTO fr_donors (
              ...
              first_name, last_name, hebrew_name, hebrew_first_name, hebrew_last_name, hebrew_father_name, hebrew_title, hebrew_suffix_title,
              title, spouse_name,
      ...
      args: [
        ...
        body.hebrew_title || null,
        body.hebrew_suffix_title || null,
        body.title || null,
