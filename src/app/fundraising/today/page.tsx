    ...
    <div style={{ maxWidth: 1180, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          {/* Hebrew date hero matches the dashboard's treatment: gematriya as the main line,
              English transliteration as a small helper underneath. The "Today's desk" label
              stays as a sub-title but doesn't dominate. */}
          <h1
            style={{
          ...
          >
            Today&rsquo;s desk · {data.today.hebrewEn}
          </div>
